...
namespace LanchesMac.Areas.Admin.Controllers
{
    ...
    public class AdminSnacksController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("SnackId,Name,ShortDescription,DetailedDescription,Price,ImageUrl,ImageThumbnailUrl,IsFavoriteSnack,InStock,CategoryId")] Snack snack)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("SnackId,Name,ShortDescription,DetailedDescription,Price,ImageUrl,ImageThumbnailUrl,IsFavoriteSnack,InStock,CategoryId")] Snack snack)
        {
            if (id != snack.SnackId)
            {
                return NotFound();
